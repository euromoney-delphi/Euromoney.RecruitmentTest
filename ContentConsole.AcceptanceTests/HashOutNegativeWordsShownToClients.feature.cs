...
#line 1 "HashOutNegativeWordsShownToClients.feature"
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("The weather in Manchester in winter is bad. It must be horrible for people visiti" +
            "ng.", "bad,horrible,swine", "The weather in Manchester in winter is b#d. It must be h######e for people visiti" +
            "ng.", null)]
        [NUnit.Framework.TestCaseAttribute("The weather in Manchester in winter is bad. It must be horrible for people visiti" +
            "ng.", "annoying,swine", "The weather in Manchester in winter is bad. It must be horrible for people visiti" +
            "ng.", null)]
        public virtual void ReplaceTheMiddleLettersWithHashesForNegative(string content, string bannedWords, string output, string[] exampleTags)
        {
